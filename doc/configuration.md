...
| `spillThreshold` | positive integer | `65536` | Sidecar threshold for missing archives of summary-covered chains. New results are not eagerly spilled. Non-positive / invalid values fall back to the default. See [Spilled outputs](#spilled-outputs) |
...
| `/pruner recovery-grace [n]` | Show or set structural recovery-chain deferral, in user-turn-groups (`0` disables deferral, not verbatim protection) |
