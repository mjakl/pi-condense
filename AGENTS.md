...
| `context-prune-frontier` | `flushPending` | Last completed prune boundary (advances on `skipped-trivial` / `skipped-deduped`, not rejected summaries; historical `skipped-oversized` entries remain readable) |
