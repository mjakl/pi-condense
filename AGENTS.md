...
| `context-prune-frontier` | `flushPending` | Last completed prune boundary (advances on `summarized`, `skipped-oversized` = deterministic rejection with originals retained verbatim, `skipped-deduped`, `skipped-trivial`; not on transient/auth failures) |
